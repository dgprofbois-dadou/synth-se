...
.dnd-instructions.dnd-instructions-hud {
  position: absolute;
  top: var(--mq-instr-hud-top, 12px);
  left: 12px;
  right: auto;
  bottom: auto;
  z-index: 180;
...
.dropzone.dnd-step-zone-hidden .dnd-placed {
  pointer-events: auto !important;
}
.dropzone.dnd-step-zone-hidden .dnd-dropzone-id-badge {
  display: none !important;
}
.draggable.dnd-step-source-hidden {
...
`;
  ...
  if (styleCss.indexOf('dnd-instructions-hud') < 0) {
    styleCss += `
.dnd-instructions.dnd-instructions-hud {
  position: absolute;
  top: var(--mq-instr-hud-top, 12px);
...
.canvas-container > .dnd-instructions-hud { top: var(--mq-instr-hud-top, 12px); }
`;
  }
  if (styleCss.indexOf('dnd-instructions-active') < 0) {
    styleCss += `
.dnd-instructions.dnd-instructions-hud:not(.dnd-instructions-active) {
  display: none !important;
}
